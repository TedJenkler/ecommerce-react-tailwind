...
const XX99_MARK_l = ( {} ) => {
    ...
    return (
        <main>
            ...
            <div className="flex flex-col items-center">
                <Suggestion link1="/XX99_MARK_ll" img1={suggestionxx99} alt1="xx99mark2" h21="XX99 MARK II" img2={suggestionxx59} alt2="XX59" h22="XX59" img3={suggestionzx9} alt3="ZX9 SPEAKER" h23="ZX9 SPEAKER" />
            </div>
