        ...
        <form className="flex flex-col w-11/12 p-6 bg-white rounded-lg mb-8">
            ...
            <div className="md:flex md:gap-4">
                <div className="md:w-1/2">
                    ...
                    <input onChange={(e) => {dispatch({type: 'changename', payload: e.target.value})}} value={state.form.name} className={state.validation.name === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg w-full" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg w-full" } name="name" placeholder="Alexei Ward"></input>
                </div>
                <div className="md:w-1/2">
                    <div className="flex justify-between">
                    ...
                    <input onChange={(e) => {dispatch({type: 'changeemail', payload: e.target.value})}} value={state.form.email} className={state.validation.email === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg w-full" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg w-full"} name="email" placeholder="alexei@mail.com"></input>
                </div>
            </div>
            ...
            <input onChange={(e) => {dispatch({type: 'changephone', payload: e.target.value})}} value={state.form.phone} className={state.validation.phone === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg md:w-1/2 md:mb-12" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg md:w-1/2 md:mb-12"} name="phone" placeholder="+1 202-555-0136"></input>
            {/* Shipping Info Part*/}
            ...
            <div className="md:flex md:gap-4">
                <div className="md:w-1/2">
                    ...
                    <input onChange={(e) => {dispatch({type: 'changepostal', payload: e.target.value})}} value={state.form.postal} className={state.validation.postal === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg w-full" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg w-full"} name="postal" placeholder="10001"></input>
                </div>
                <div className="md:w-1/2">
                    <div className="flex justify-between">
                    ...
                    <input onChange={(e) => {dispatch({type: 'changecity', payload: e.target.value})}} value={state.form.city} className={state.validation.city === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg w-full" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg w-full"} name="city" placeholder="New York"></input>
                </div>
            </div>
            <div className="flex justify-between md:w-1/2">
            ...
            <input onChange={(e) => {dispatch({type: 'changecountry', payload: e.target.value})}} value={state.form.country} className={state.validation.country === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg md:w-1/2 md:mb-12" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg md:w-1/2 md:mb-12"} name="country" placeholder="United States"></input>
            {/* Payment Part*/}
            ...
            <div className="md:flex">
                ...
                <div className="md:w-1/2">
                    ...
                    <input onChange={(e) => {dispatch({type: 'changepin', payload: e.target.value})}} value={state.form.epin} className={state.validation.enumber === false ? "py-4 pl-6 mb-6 border errorborder rounded-lg w-full" : "py-4 pl-6 mb-6 border border-bordergrey rounded-lg w-full"} placeholder="6891"></input>
                    </div>
                </div>
            </div>
        </form>
