...
const Conformation = ( {toggle} ) => {
    ...
    return (
        <section className={toggle === false ? " bg-white rounded-lg w-11/12 p-8 pb-16 absolute left-0 right-0 mx-auto top-56 z-50 md:w-3/4" : "hidden bg-white rounded-lg w-11/12 p-8 pb-16 absolute left-0 right-0 mx-auto top-56"}>
            ...
            <div className="md:flex md:h-36 md:mb-24 md:w-full">
                <div className="md:flex md:flex-col">
                    <div className="border-b border-bordergrey bg-greywhite rounded-t-lg p-6 md:rounded-tl-lg md:rounded-tr-none">
                ...
                <div className="bg-black2 pt-4 px-6 pb-5 mb-6 rounded-b-lg md:rounded-r-lg md:rounded-l-none md:h-52 md:flex md:flex-col md:justify-center md:w-1/2">
