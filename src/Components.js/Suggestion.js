        ...
        <section className="flex flex-col items-center md:w-11/12">
            ...
            <div className="flex flex-col items-center md:flex-row md:gap-3">
                <div className="flex flex-col items-center md:w-56">
                    <div className="w-full bg-greywhite flex justify-center mb-8 items-center rounded-lg md:h-56"><img className="h-32 mb-8 md:h-56 md:w-56 md:mb-0" src={img1} alt={alt1} /></div>
                ...
                <div className="flex flex-col items-center md:w-56">
                    <img className="h-32 w-full mb-8 md:h-56 md:w-56" src={img2} alt={alt2} />
                ...
                <div className="flex flex-col items-center w-full md:w-56">
                    <div className="w-full bg-greywhite flex justify-center mb-8 rounded-lg"><img className="h-32 md:h-56 md:w-56" src={img3} alt={alt3} /></div>
